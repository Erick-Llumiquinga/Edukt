...
const routes: Routes = [
  ...
  { path: 'materias/editar', /*canActivate: [ TokenGuard ],*/ loadChildren: () => import('./subjects/edit-subject/edit-subject.module').then(m => m.EditSubjectModule)},
  ...
  { path: 'clases/editar', /*canActivate: [ TokenGuard ],*/ loadChildren: () => import('./classes/edit-class/edit-class.module').then(m => m.EditClassModule)}
]
@NgModule({
